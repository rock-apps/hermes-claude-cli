...
**This plugin does not run an HTTP server.** That approach was evaluated and rejected in [`docs/04-is-bridge-necessary.md`](./docs/04-is-bridge-necessary.md). Instead it uses Hermes Agent's native mechanism for non-HTTP providers:
